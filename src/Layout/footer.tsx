      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        <div>
          ...
          <nav className="mt-6 py-2 border-t-2 w-3xs flex space-x-6 text-sm font-medium">
            ...
            <Link to="sponser" className="hover:text-blue-500">Sponser</Link>
          </nav>
        </div>
      ...
      <div className="bg-black text-white py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-sm">
          <div className="flex space-x-4 mb-2 md:mb-0">
            ...
            <Link to="history" className="hover:text-red-500">Our History</Link>
            <span className="text-red-500">|</span>
            <Link to="contact" className="hover:text-red-500">Contact Us</Link>
            <span className="text-red-500">|</span>
            <Link to="What-we-do" className="hover:text-red-500">What We Do?</Link>
          </div>
